...
urlpatterns = [
    ...
    path('bands/<int:id>/edit/', views.band_edit, name='band-edit'),
    ...
    path('listings/add/', views.list_create, name='listing-create'),
    path('listing/<int:id>/edit/', views.listing_edit, name='list-edit'),
